...
df = df[["label", "norm_weighted_speedup", "norm_bh_speedup", "norm_bh_energy", "configstr", "norm_energy", "norm_max_slowdown", "tRH"]].groupby(["label", "configstr","tRH"]).mean().reset_index()
