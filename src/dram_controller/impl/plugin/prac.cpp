...
class PRAC : public IControllerPlugin, public Implementation, public IPRAC, public IThrottleable {
...
public:
    ...
    void update(bool request_found, ReqBuffer::iterator& req_it) override {
        ...
        // if (m_debug && m_state == IPRAC::ABOState::PRE_RECOVERY) {
        //     std::printf("[PRAC] [%lu] [PRE-REC-SCHED] cmd: %d, min_cycles: %d, next_recovery: %lu\n",
        //         m_clk, req_it->command, this->min_cycles_with_preall(req_it), m_abo_recovery_start);
        // }
